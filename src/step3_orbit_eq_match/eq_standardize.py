...
#**************************************************************************************************
# [2.   Setting the path/directory]
EQ_DATA = Path(r"E:\tables\earthquake_catalog\declustered\eq_m4.8above_depth40kmbelow_2004_2010_declustered_ver1.csv")
...
# [6.   Exporting the data frame as a csv file]
# 6-1.  Outputing dataframe as a csv file.
df.to_csv(OUTPUT_DIR / "eq_standardize_ver2.csv", index=False)
#
#**************************************************************************************************